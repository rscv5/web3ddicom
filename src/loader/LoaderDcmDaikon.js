...
import DicomTagInfo from '../dicomvol/dicomsliceinfo';
...
class LoaderDcmDaikon {
    ...
    loadSingleSlice(fileIndex, fileName, strContent) {
        // console.log('LoaderDcmDaikon loadSingleSlice:', fileName, 'Index:', fileIndex);
        const dataFile = new DataView(strContent);
        let image = null;
        try {
            image = daikon.Series.parseImage(dataFile);
        ...
        const bodyPartExamined = 'NoExistInDiakonReader';
        ...
        // console.log('>>>>>>>loader>>>>>',this.m_loaderDicom)
        ...
        if (this.m_loaderDicom.m_pixelRepresentationSigned) {
