...
import Hash from '../loader/utils/Hash';
...
class DicomSlice {
    ...
    buildHash() {
        const strMix = this.m_patientName + this.m_studyDescr + this.m_studyDate +
            this.m_seriesTime + this.m_seriesDescr + this.m_bodyPartExamined;
