 ...
 * @module app/scripts/engine/VolumeRender3d
 */
 import * as THREE from 'three';

 import GlSelector from '../ui/GlSelector';
 ...
 import MaterialInterpolation from '../gfx/matvolumerender';
 import MaterialVolumeRender from '../gfx/matvolumerender';
 import VolumeFilter3d from '../gfx/volumeFilter3d';
 import RoiPalette from '../dicomvol/roipalette';
 import TetrahedronGenerator from '../features/tetra';
 
 // import Graphics23d from './tools23d/graphics3d'
 ...
 export default class VolumeRenderer3d {
     ...
     constructor(props){
         ...
         this.orbitControl = new OrbitControl(this.renderer.domElement, this.camera, this.scene, this.meshSphere, ()=>{
             if(true){
     ...
     /**
      * Returns true if the mederial for VolumeRender is set
      */
     isVolumeLoaded(){
     ...
     /**
      * Gen screen copy image from current render
      * 
     ...
     /**
      * Setting a variable for conditional comilation (Max projection render)
      * 
      */
     switchToFLATRender(){
    ...
    */
     ...
     */
      ...
      */
     initWithVolume(volume, box, nonEmptyBoxMin, nonEmptyBoxMax, isRoiVolume, isFULL3D, index) {
         ...
         this.volume = volume; // loaderdicom
         ...
         this.volTexture = this.volumeUpdater.createUpdatableVolumeTex(this.volume, isRoiVolume, this.roiPalette, index);
